...
{
$dataProvider=new CActiveDataProvider('CardHolder');
...
{
$model=new CardHolder('search');
$model->unsetAttributes();  // clear any default values
if(isset($_GET['CardHolder']))
$model->attributes=$_GET['CardHolder'];
...
{
$model=CardHolder::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='card-holder-form')
{
