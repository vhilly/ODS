<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('is_student')); ?>:</b>
	<?php echo CHtml::encode($data->is_student); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('is_employed')); ?>:</b>
	<?php echo CHtml::encode($data->is_employed); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('company_school_address')); ?>:</b>
	<?php echo CHtml::encode($data->company_school_address); ?>
	<br />
